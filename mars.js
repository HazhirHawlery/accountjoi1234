...
`HazhirHawlery`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS2.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});

MARS3.on("ready", () => { console.log( `Online In Servers` ); let statuses = [ 
`Mr ᴴᵃᶻʰᶦʳᴴᵃʷˡᵉʳʸ`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS3.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});

MARS4.on("ready", () => { console.log( `Online In Servers` ); let statuses = [ 
`Mr ᴴᵃᶻʰᶦʳᴴᵃʷˡᵉʳʸ`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS4.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});

MARS5.on("ready", () => { console.log( `Online In Servers` ); let statuses = [ 
`Mr ᴴᵃᶻʰᶦʳᴴᵃʷˡᵉʳʸ`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS5.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});

MARS6.on("ready", () => { console.log( `Online In Servers` ); let statuses = [ 
`Mr ᴴᵃᶻʰᶦʳᴴᵃʷˡᵉʳʸ`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS6.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});

MARS7.on("ready", () => { console.log( `Online In Servers` ); let statuses = [ 
`Mr ᴴᵃᶻʰᶦʳᴴᵃʷˡᵉʳʸ`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS7.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});

MARS8.on("ready", () => { console.log( `Online In Servers` ); let statuses = [ 
`Mr ᴴᵃᶻʰᶦʳᴴᵃʷˡᵉʳʸ`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS8.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});

MARS9.on("ready", () => { console.log( `Online In Servers` ); let statuses = [ 
`Mr ᴴᵃᶻʰᶦʳᴴᵃʷˡᵉʳʸ`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS9.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});

MARS10.on("ready", () => { console.log( `Online In Servers` ); let statuses = [ 
`Mr ᴴᵃᶻʰᶦʳᴴᵃʷˡᵉʳʸ`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS10.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});

MARS11.on("ready", () => { console.log( `Online In Servers` ); let statuses = [ 
`Mr ᴴᵃᶻʰᶦʳᴴᵃʷˡᵉʳʸ`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS11.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});

MARS12.on("ready", () => { console.log( `Online In Servers` ); let statuses = [ 
`Mr ᴴᵃᶻʰᶦʳᴴᵃʷˡᵉʳʸ`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS12.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});

MARS13.on("ready", () => { console.log( `Online In Servers` ); let statuses = [ 
`Mr ᴴᵃᶻʰᶦʳᴴᵃʷˡᵉʳʸ`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS13.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});

MARS14.on("ready", () => { console.log( `Online In Servers` ); let statuses = [ 
`Mr ᴴᵃᶻʰᶦʳᴴᵃʷˡᵉʳʸ`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS14.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});

MARS15.on("ready", () => { console.log( `Online In Servers` ); let statuses = [ 
`Mr ᴴᵃᶻʰᶦʳᴴᵃʷˡᵉʳʸ`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS15.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});

MARS16.on("ready", () => { console.log( `Online In Servers` ); let statuses = [ 
`Mr ᴴᵃᶻʰᶦʳᴴᵃʷˡᵉʳʸ`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS16.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});

MARS17.on("ready", () => { console.log( `Online In Servers` ); let statuses = [ 
`Mr ᴴᵃᶻʰᶦʳᴴᵃʷˡᵉʳʸ`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS17.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});

MARS18.on("ready", () => { console.log( `Online In Servers` ); let statuses = [ 
`Mr ᴴᵃᶻʰᶦʳᴴᵃʷˡᵉʳʸ`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS18.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});

MARS19.on("ready", () => { console.log( `Online In Servers` ); let statuses = [ 
`Mr ᴴᵃᶻʰᶦʳᴴᵃʷˡᵉʳʸ`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS19.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});

MARS20.on("ready", () => { console.log( `Online In Servers` ); let statuses = [ 
`Mr ᴴᵃᶻʰᶦʳᴴᵃʷˡᵉʳʸ`, ]; setInterval(function() { let STREAMING = statuses[Math.floor(Math.random() * statuses.length)]; MARS20.user.setActivity(STREAMING, { type: "playing", url: "https://www.twitch.tv/faith" }); }, 2000);});
...
MARS.login("NzI0MDE0ODgzNzYyNDcwOTMz.X2Msug.XApszdYB4dyIMZ24ix4BFSxVlNU");
MARS2.login("NzU1NDg1NTE2MTAyODkzNjEw.X2NDtg.njWwdDMxRmjtGGyABLguNTE7RDA");
MARS3.login("NzU2MTEwMjgyOTI4OTQ3MjAx.X2NFJg.JQvOGiwS3HfhUPtlRAAmD0EJZos");
MARS4.login("NzU2MTExNDMwMDY2ODk2ODk3.X2NG6w.qrvx-lkIje8Dyj5qzVzXiYluNvg");
MARS5.login("NzU2MTEyMDk4Mzc5MTY5ODYy.X2NGgA.GDLTguuFsTbMlgNCzvzVWMECfLI");
MARS6.login("NzU2MTEyOTIxNTQ0NzUzMTYz.X2NHKw.sciTwqrlRWxs9uvAi0F-5wPDR7c");
MARS7.login("NzU2MTEzMzQ2ODk3Mzc5NDI4.X2NHow.qCtLK9rnCEMgY1ar1WwryAiLMDA");
MARS8.login("NzU2MTEzNzk3NzY4NDEzMjc2.X2NIIg.zw0GYREWpsfHtIeddKZt_GfUr1U");
MARS9.login("NzU2MTE0Mzc3MDM5Njc1NDMz.X2NImw.LTeD3HGmp2CiOMIZHlp_5DgpOWY");
MARS10.login("NzU2MTE0ODY2NzM3MTE5MjY4.X2NJFg.awPm_RayTdNmW9W236CIsqJz5v8");
MARS11.login("NzU2MTE1NTQ4OTk5Mzg1MTE5.X2NJjQ.eEnKhc1QPK7ZpxzgSy6tB_5YM40");
MARS12.login("NzU2MTE1OTE0ODM1MDk5NzA5.X2NMjA.M7G1Lgmls4y-qXQmm7hsJHiwypg");
MARS13.login("NzU2MTIwMDU1MjMzOTA0NjUw.X2NNxA.2lK4FrfmQzw0rVUA8ZHvJCbWa4k");
MARS14.login("NzU2MTIwMzY4MDg2OTA4OTI5.X2NOPA.-tyHCeFESP3d18ndDHHNq7gBi2Q");
MARS15.login("NzU2MTIwOTU2MDI3NjY2NTEz.X2NOwg.HDd3f1aFj3ytzI1U-P3-x750UfQ");
MARS16.login("NzU2MTIxNDkyMjM2MDA5NTIy.X2NPSA.R5g969wtwexJg-6CR4aIfmHEqjk");
MARS17.login("NzU2MTIyMDExNTk5NjM0NDMy.X2NPwg.TtqTjgtP-CTfSN3mU3YV3psP4Uk");
MARS18.login("NzU2MTIyODIxMDk2MjQzMjMz.X2NQWg.Uz4bbyG4a97AlUg8crXigMAhnYA");
MARS19.login("NzU2MTIzMTI1OTg4NDU4NTg3.X2NQ1Q.yHF4U9Era7pUisN02IWdUemMioA");
MARS20.login("NzU2MTIzNjQ0OTQ5NjkyNTI3.X2NRVQ.WylP02-n-Tn3Z1lSnGmzAFa0UyY");
MARS21.login("NzU2MjU1NzIzMTYzMzUzMTI4.X2PNCw.bsbpMxufI4Uby_VJW16Dz618zsI");
MARS22.login("");
MARS23.login("");
MARS24.login("");
MARS25.login("");
